...
gsap.from('.home__image-6', 1.5, {opacity: 0, y: 200, delay: .1, ease: 'back.out(1.5)'})
gsap.from('.home__image-3', 1.5, {opacity: 0, y: 400, delay: .3, ease: 'back.out(1.5)'})
...
gsap.from('.home__latern-1', 1.5, {opacity: 0, x: 70, delay: 3, ease: 'back.out(1.5)'})
gsap.from('.home__latern-2', 1.5, {opacity: 0, x: -70, delay: 3.5, ease: 'back.out(1.5)'})
